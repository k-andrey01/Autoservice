...
namespace Autoservice.Migrations
{
    ...
    [Migration("20211209221253_MigrOneToOne")]
    partial class MigrOneToOne
    {
            ...
            modelBuilder.Entity("Autoservice.Models.Request", b =>
                {
                    b.HasOne("Autoservice.Models.ClientCar", "ClientCars")
                        .WithOne("Requests")
                        .HasForeignKey("Autoservice.Models.Request", "ClientCarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Autoservice.Models.Client", "Clients")
                        .WithOne("Requests")
                        .HasForeignKey("Autoservice.Models.Request", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Autoservice.Models.Master", "Masters")
                        .WithOne("Requests")
                        .HasForeignKey("Autoservice.Models.Request", "MasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
